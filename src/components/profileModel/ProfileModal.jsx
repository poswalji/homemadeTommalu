          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="px-4 py-3 bg-gray-50 rounded-lg text-gray-800">{user.favoriteRestaurant}</div>
              </div>
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <div className="px-4 py-3 bg-gray-50 rounded-lg text-gray-800">{user.address}</div>
              )}
            </div>
          </div>
