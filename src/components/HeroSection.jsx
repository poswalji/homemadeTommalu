...
export default function HeroSection() {
  ...
  <div className="absolute inset-0 z-20 flex flex-col items-center justify-center px-4">
    ...
    <div className="flex flex-wrap justify-center gap-4 mb-4">
      <Link href='/food' className="px-6 py-2 rounded-full font-semibold bg-gradient-to-r from-orange-500 to-red-500 text-white shadow-lg">
        🍕 Food Delivery
      </Link>
      <Link href='/grocery' className="px-6 py-2 rounded-full font-semibold bg-gradient-to-r from-green-500 to-blue-500 text-white shadow-lg">
        🛒 Grocery Shopping
      </Link>
    </div>
  </div>
