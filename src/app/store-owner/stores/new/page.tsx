...
export default function CreateStorePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    phone: '',
    licenseNumber: '',
    licenseType: 'FSSAI' as 'FSSAI' | 'GST' | 'Shop Act' | 'Trade License' | 'Other',
    category: 'Fast Food' as string,
    description: '',
    openingTime: '09:00',
    closingTime: '23:00',
    deliveryFee: '0',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Store created successfully! Waiting for admin verification.');
  ...
  return (
    <div className="space-y-6 p-4 md:p-6 lg:p-8 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Create New Store</h1>
          <p className="text-gray-600 mt-2 text-sm">Fill in the details to create your store</p>
        </div>
      </div>
