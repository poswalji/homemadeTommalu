...
import { useStoreOwnerOrders, useStoreOwnerUpdateOrderStatus } from '@/hooks/api';
...
import { Package, Search, Eye, CheckCircle, XCircle, Truck } from 'lucide-react';
...
export default function StoreOwnerOrdersPage() {
    ...
    try {
      await updateStatus.mutateAsync({
        ...
        data: {
          ...
          ...(statusUpdate.status === 'Rejected' && statusUpdate.rejectionReason
            ? { rejectionReason: statusUpdate.rejectionReason }
            : {}),
          ...(statusUpdate.status === 'Cancelled' && statusUpdate.cancellationReason
  ...
  const openStatusDialog = (orderId: string, currentStatus: string) => {
    ...
    setStatusUpdate({ status: currentStatus, rejectionReason: '', cancellationReason: '' });
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">View and manage orders for your stores</p>
      </div>
      ...
      <Card className="p-6">
        ...
        {filteredOrders.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">Orders from your stores will appear here</p>
          </div>
        ) : (
            ...
            {filteredOrders.map((order: any) => (
              <Card key={order.id} className="p-6 hover:shadow-lg transition-shadow">
                ...
                <div className="flex gap-2">
                  <Link href={`/store-owner/orders/${order.id}`} className="flex-1">
